...
-- Vaults
-- ==========================================================
IF OBJECT_ID('dbo.Vaults', 'U') IS NULL
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_Characters_ArtifactHash' AND object_id = OBJECT_ID('dbo.Characters'))
BEGIN
    CREATE INDEX IX_Characters_ArtifactHash ON dbo.Characters(artifact_item_hash);
END;

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_Characters_UserId' AND object_id = OBJECT_ID('dbo.Characters'))
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_Items_Character_Equipped' AND object_id = OBJECT_ID('dbo.Items'))
BEGIN
    CREATE INDEX IX_Items_Character_Equipped ON dbo.Items(character_id, is_equipped);
END;

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_Items_ItemHash' AND object_id = OBJECT_ID('dbo.Items'))
BEGIN
    CREATE INDEX IX_Items_ItemHash ON dbo.Items(item_hash);
END;

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_Items_InstanceId' AND object_id = OBJECT_ID('dbo.Items'))
BEGIN
...
-- ItemStats
-- ==========================================================
IF OBJECT_ID('dbo.ItemStats', 'U') IS NULL
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_ItemStats_StatHash_Value' AND object_id = OBJECT_ID('dbo.ItemStats'))
BEGIN
    CREATE INDEX IX_ItemStats_StatHash_Value ON dbo.ItemStats(stat_hash, stat_value DESC);
END;

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_ItemStats_ItemId' AND object_id = OBJECT_ID('dbo.ItemStats'))
BEGIN
...
-- ItemSockets
-- ==========================================================
IF OBJECT_ID('dbo.ItemSockets', 'U') IS NULL
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_ItemSockets_ItemId' AND object_id = OBJECT_ID('dbo.ItemSockets'))
BEGIN
...
-- ItemPlugs
-- ==========================================================
IF OBJECT_ID('dbo.ItemPlugs', 'U') IS NULL
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_ItemPlugs_ItemId' AND object_id = OBJECT_ID('dbo.ItemPlugs'))
BEGIN
    CREATE INDEX IX_ItemPlugs_ItemId ON dbo.ItemPlugs(item_id);
END;

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_ItemPlugs_SocketIndex' AND object_id = OBJECT_ID('dbo.ItemPlugs'))
BEGIN
    CREATE INDEX IX_ItemPlugs_SocketIndex ON dbo.ItemPlugs(socket_index);
END;

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_ItemPlugs_PlugHash' AND object_id = OBJECT_ID('dbo.ItemPlugs'))
BEGIN
...
-- ItemSocketChoices
-- ==========================================================
IF OBJECT_ID('dbo.ItemSocketChoices', 'U') IS NULL
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_ItemSocketChoices_Plug' AND object_id = OBJECT_ID('dbo.ItemSocketChoices'))
BEGIN
    CREATE INDEX IX_ItemSocketChoices_Plug ON dbo.ItemSocketChoices(plug_hash);
END;

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_ItemSocketChoices_Inst' AND object_id = OBJECT_ID('dbo.ItemSocketChoices'))
BEGIN
...
-- ItemSandboxPerks
-- ==========================================================
IF OBJECT_ID('dbo.ItemSandboxPerks', 'U') IS NULL
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_ItemSandboxPerks_Hash' AND object_id = OBJECT_ID('dbo.ItemSandboxPerks'))
BEGIN
    CREATE INDEX IX_ItemSandboxPerks_Hash ON dbo.ItemSandboxPerks(sandbox_perk_hash);
END;

IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_ItemSandboxPerks_Inst' AND object_id = OBJECT_ID('dbo.ItemSandboxPerks'))
BEGIN
...
-- ItemEnergy
-- ==========================================================
IF OBJECT_ID('dbo.ItemEnergy', 'U') IS NULL
BEGIN
...
-- ItemSocketLayout
-- ==========================================================
IF OBJECT_ID('dbo.ItemSocketLayout', 'U') IS NULL
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_ItemSocketLayout_ItemHash' AND object_id = OBJECT_ID('dbo.ItemSocketLayout'))
BEGIN
