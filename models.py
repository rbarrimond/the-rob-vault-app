...
class ItemModel(BaseModel):
    ...
    def from_raw_data(
        ...
        """
        manifest_cache.ensure_manifest_cache()
        ...
        if item_instance_id:
            instance_info = cls._build_instance_info(item_instance_id, manifest_cache)
    ...
    def _build_instance_info(
        ...
        """
        info = {}
        instance_data = manifest_cache.get_instance_data(item_instance_id)
